...
--
-- Table structure for table `cascade_equal_categories`
--

DROP TABLE IF EXISTS `cascade_equal_categories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cascade_equal_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `question_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
...
CREATE TABLE `cascade_stats` (
  ...
  `min_response_time` int(11) DEFAULT '0',
  `max_response_time` int(11) DEFAULT '0',
...
CREATE TABLE `fit_reviews` (
  ...
  KEY `question_index` (`question_id`),
  KEY `question_category_index` (`question_id`,`category`),
  KEY `question_reviewer_index` (`question_id`,`reviewer_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-01-27 13:07:52
