...
CREATE TABLE `question_stats` (
  ...
  `cascade_iteration_count` int(11) DEFAULT '0',
  `cascade_step1_duration` int(11) DEFAULT '0',
  `cascade_step2_duration` int(11) DEFAULT '0',
  `cascade_step3_duration` int(11) DEFAULT '0',
  `cascade_step4_duration` int(11) DEFAULT '0',
  `cascade_step5_duration` int(11) DEFAULT '0',
  `cascade_step6_duration` int(11) DEFAULT '0',
  `cascade_total_duration` int(11) DEFAULT '0',
...
-- Dump completed on 2013-07-22 16:16:26
