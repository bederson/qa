...
CREATE TABLE `cascade_stats` (
  ...
  `step2_duration` int(11) DEFAULT '0',
...
--
-- Table structure for table `cascade_times`
--

DROP TABLE IF EXISTS `cascade_times`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cascade_times` (
  `question_id` int(11) NOT NULL,
  `iteration` int(11) DEFAULT NULL,
  `step1_start` timestamp NULL DEFAULT NULL,
  `step1_end` timestamp NULL DEFAULT NULL,
  `step2_start` timestamp NULL DEFAULT NULL,
  `step2_end` timestamp NULL DEFAULT NULL,
  `step3_start` timestamp NULL DEFAULT NULL,
  `step3_end` timestamp NULL DEFAULT NULL,
  `step4_start` timestamp NULL DEFAULT NULL,
...
-- Dump completed on 2013-08-20 13:37:10
